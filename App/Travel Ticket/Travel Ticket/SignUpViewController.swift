...
class SignUpViewController:UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        conPasswordField.delegate = self
    ...
    @objc func textFieldChanged(_ target:UITextField) {
        ...
        let conpass = conPasswordField.text
        let name = nameField.text
        let surName = surNameField.text
        let formFilled = username != nil && username != "" && email != nil && email != "" && name != nil && name != "" && surName != nil && surName  != "" && password != nil && password != ""
    ...
    @objc func handleSignUp() {
        ...
        guard let conpass = conPasswordField.text else {return}
